...
class Ui_WndMain(object):
    def setupUi(self, WndMain):
        ...
        self.actionNew = QAction(WndMain)
        self.actionNew.setObjectName(u"actionNew")
        self.actionClose = QAction(WndMain)
        ...
        sizePolicy.setHeightForWidth(self.tblDiag.sizePolicy().hasHeightForWidth())
        self.tblDiag.setSizePolicy(sizePolicy)
        self.tblDiag.setMaximumSize(QSize(900, 16777215))
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 93, 545))
        ...
        self.actionNew.triggered.connect(WndMain.newWindow)
        self.actionClose.triggered.connect(WndMain.close)
...
#endif // QT_CONFIG(shortcut)
        self.actionNew.setText(QCoreApplication.translate("WndMain", u"New Window", None))
#if QT_CONFIG(shortcut)
        self.actionNew.setShortcut(QCoreApplication.translate("WndMain", u"Ctrl+N", None))
#endif // QT_CONFIG(shortcut)
        self.actionClose.setText(QCoreApplication.translate("WndMain", u"Close", None))
#if QT_CONFIG(shortcut)
        self.actionClose.setShortcut(QCoreApplication.translate("WndMain", u"Ctrl+W", None))
#endif // QT_CONFIG(shortcut)
